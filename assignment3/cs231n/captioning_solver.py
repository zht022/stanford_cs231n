...
class CaptioningSolver(object):
    ...
    def __init__(self, model, data, **kwargs):
        ...
        # For pop(), if the first param (here is 'update_rule') do not exist, return the second one (here is 'sgd')
    ...
    def train(self):
        ...
        for t in range(num_iterations):
            self._step() ## every step/iteration, we train batch_size of features
